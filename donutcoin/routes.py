from donutcoin.models import User
from donutcoin.forms import *
from flask import Flask, jsonify, request, render_template, url_for, flash, redirect
from donutcoin import app, db, bcrypt
from donutcoin import blockchainObj
from flask_login import login_user, current_user, logout_user, login_required
from Crypto.PublicKey import RSA
import requests
from twilio.rest import Client 
from donutcoin.forms import TransactionForm
...
def transaction():
    ...
    if form.validate_on_submit():
        ...
        if feedback:
            re = form.reciever.data;
            numw = form.number.data;
            account_sid = 'AC81c745528c0842aac5e2f5f8727ade82' 
            auth_token = f'{api_key}' 
            client = Client(account_sid, auth_token) 
            message = client.messages.create(  
                              messaging_service_sid='MGc116909a1016558d0670a56e0b08190b', 
                              body=f'Transaction made Successfully to - {re} ',      
                              to=f'{numw}' 
                          ) 
